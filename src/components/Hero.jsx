...
import profilePic from "../assets/IMG_0423.JPG"
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
               <div className="flex flex-col items-center lg:items-start text-white">
                     <motion.h1  
                       ...
                       initial="hidden"
                       animate="visible"
                     className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl '>Alen Joy</motion.h1>
                     <motion.span
            ...
            <div className="w-full lg:w-1/2 lg:p-8 ">
                <div className="flex justify-center">
                    ...
                    className="md:mr-6 xl:ml-10 2xl:ml-80" style={{height:"450px"}} src={profilePic} alt="" />
                </div>
            </div>
        </div>
